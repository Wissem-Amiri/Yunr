    ...
    <div className="auth-split">
      ...
      <div className="auth-left">
        <div>
          ...
          <p className="auth-footer">
            ...
            <Link href="/auth/register" className="auth-link">Sign up</Link>
          </p>
        </div>
      ...
      <div className="auth-right">
        <div className="auth-right-overlay">
          ...
          <h2>Streamline your HR management</h2>
          <p>Présence IA, gestion des congés et recrutement — tout en un seul endroit.</p>
